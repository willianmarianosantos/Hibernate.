...
public class listarLivros extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            // Obter o EntityManager através do contexto de persistência (como você já faz na sua aplicação)
            ...
            // Fechar o EntityManager (idealmente deve ser gerenciado externamente, usando um contexto de persistência)
            entityManager.close();
